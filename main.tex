...
\end{aligned}
\]
where $V_0=\|\phi_0-\phi^\ast_{\lambda_c}\|^2$. Hence for any target failure probability $\delta$, choosing
\[
N_0=O\!\left((\mu_{\lambda_c}\alpha_0)^{-1}\log\tfrac{V_0}{\delta\rho^2}\right)
\]
and $\alpha_0$ small enough gives phase-2 entry with probability at least $1-\delta$. On this event,
\[
\|\phi_{N_0}-\phi^\ast\|
\le
