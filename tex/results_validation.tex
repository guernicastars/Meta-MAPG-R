...
% =====================================================================
\section{Phase P : peer-correction projection toward $(C,C)$}\label{sec:phase-p}

\input{phase_p.tex}

% =====================================================================
\section{Phase R : alignment-to-entry regression}\label{sec:phase-r}
...
% =====================================================================
\section{Phase Q : cell-bootstrap coordination-game sweep}\label{sec:phase-q}
...
% =====================================================================
\section{Phase M : peer-coefficient sweep}\label{sec:phase-m}

\input{phase_m.tex}

% =====================================================================
\section{Phase N : summary metrics and endpoint welfare}\label{sec:phase-n}

\input{phase_n.tex}

% =====================================================================
\section{Phase O : basin-gain masks relative to PG}\label{sec:phase-o}

\input{phase_o.tex}

% =====================================================================
\section{Phase T : warm-up handoff into PG}\label{sec:phase-t}

\input{phase_t.tex}

% =====================================================================
\section{Phase U : high-$\lambda$ no-clip stress test}\label{sec:phase-u}

\input{phase_u.tex}

% =====================================================================
\section{Phase V : payoff-geometry counterexample search}\label{sec:phase-v}

\input{phase_v.tex}

% =====================================================================
\section{Phase W : separatrix-margin certificate}\label{sec:phase-w}

\input{phase_w.tex}

% =====================================================================
\section{Phase X : cumulative early-alignment test}\label{sec:phase-x}

\input{phase_x.tex}

% =====================================================================
\section{Phase Y : minimal warm-up crossing time}\label{sec:phase-y}

\input{phase_y.tex}

% =====================================================================
\section{Phase Z : adversarial alignment search}\label{sec:phase-z}
