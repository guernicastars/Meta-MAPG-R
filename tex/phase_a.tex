...
\begin{figure}[h]
  ...
  \caption{Expected update directions in tabular Stag Hunt. Around the PG separatrix the Meta-MAPG arrows tilt visibly toward the payoff-dominant equilibrium $(C,C)$, which is the local mechanism behind the basin shifts in Phases~B and~C.}
