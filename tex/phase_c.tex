...
\begin{table}[h]
  ...
  \begin{tabular}{lcccc}
    ...
    \bottomrule
  \end{tabular}
  \caption{Stochastic basin entry. The Wilson interval uses the aggregate count over the full grid; Phase~Q uses the more conservative cell-bootstrap interval for the $T$-sweep.}
