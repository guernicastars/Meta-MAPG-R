...
\begin{center}
\begin{tabular}{@{}cl@{\quad}l@{\quad}p{5.2cm}@{}}
\toprule
Phase & Experiment & Anchor & Gap closed \\
\midrule
AA & Asymmetric pairings & Prop.~4.3(i) & Prosocial or exploitative correction? \\
BB & Heterogeneous $(\lambda_1,\lambda_2)$ & Prop.~4.3(ii) & Does $\mu+\lambda\mu_M$ hold off-diagonal? \\
CC & Unroll sweep $L\in\{1,3,5\}$ & As.~5 / Lem.~4.1 & Does $L>1$ improve performance? \\
DD & Annealing exponent $q$ & Thm.~4.4 Step~5 & Robustness at the summability boundary? \\
EE & Checkpoint-selection rules & Thm.~4.6 & Smarter $\phi_0$ improves $p_\rho$? \\
FF & Perturbation vs episode reset & Report~\S5 & Is episode reset $=$ policy restart? \\
\bottomrule
\end{tabular}
\end{center}
